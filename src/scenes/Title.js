class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('jogoat', 'img/jogoat.png')
    ...
    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'mickey_font', 'THE ODYSSEY', 50).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY, 'mickey_font', 'Press SPACE to start', 26).setOrigin(0.5)
